<template>
  <div>
    ...
    <select
      ...
      @change="onChange"
      class="h-18 rounded-md border border-gray-200 dark:border-[#172036] bg-white gray:bg-[#0c1427] px-4 block w-full outline-none cursor-pointer transition-all focus:border-primary-500"
    >
