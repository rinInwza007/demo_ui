  ...
  <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
    ...
    <div>
      <nav aria-label="Pagination" class="isolate inline-flex -space-x-px rounded-md shadow-xs">
        ...
        <a href="#" aria-current="page" class="  rounded-md relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">1</a>
